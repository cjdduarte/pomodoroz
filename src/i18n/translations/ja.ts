export const ja = {
  ...
  grid: {
    ...
    ungroupLabel: "グループ解除",
    priorities: "優先",
    priorityModeNormal: "優先: 通常",
    priorityModeFirst: "優先: 優先を先頭",
    priorityModeOnly: "優先: 優先のみ",
    markPriority: "優先にする",
  ...
  settings: {
    ...
    inAppAutoUpdate: "自動アップデート",
    autoUpdatePromptTitle: "自動アップデート",
    autoUpdatePromptBody:
      "新しいバージョンが見つかったときに、自動でダウンロード、インストール、再起動しますか？この設定は後で変更できます。",
    autoUpdatePromptEnable: "自動",
    autoUpdatePromptNotifyOnly: "先に確認する",
  ...
  updater: {
    promptTitle: "新しいバージョンがあります",
    promptBody:
      "バージョン {{version}} が利用できます。今すぐ更新しますか？",
    updateNow: "今すぐ更新",
    notNow: "あとで",
  },
  statistics: {
