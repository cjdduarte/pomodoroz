export const pt = {
  ...
  config: {
    ...
    specialBreakSetterDescription:
      "Defina sua pausa especial de acordo com sua rotina diária.",
    specialBreakFromLabel: "de",
    specialBreakToLabel: "até",
    specialBreakDurationLabel: "Duração",
    specialBreakInvalidDuration: "não é uma duração válida.",
  },
  timer: {
    stayFocused: "Foco",
    shortBreak: "Pausa curta",
  ...
  grid: {
    ...
    priorityModeNormal: "Prioridades: normal",
    priorityModeFirst: "Prioridades: priorizadas primeiro",
    priorityModeOnly: "Prioridades: somente priorizadas",
  ...
  sticky: {
    ...
    supportStripePix: "Me paga um café?",
  },
  settings: {
    title: "Ajustes",
    restoreDefault: "Restaurar padrão",
    ...
    drawOnlyPrioritizedTasks: "Sortear apenas priorizadas",
    ...
    inAppAutoUpdate: "Atualização automática",
    autoUpdatePromptTitle: "Atualizações automáticas",
    autoUpdatePromptBody:
      "Deseja que o app baixe, instale e reinicie automaticamente quando houver nova versão? Você pode mudar isso depois em Ajustes.",
    autoUpdatePromptEnable: "Automático",
    autoUpdatePromptNotifyOnly: "Perguntar antes",
    ...
    taskTransfer: {
      ...
      desktopOnly:
        "Importação/exportação disponível apenas no app desktop.",
  ...
  updater: {
    promptTitle: "Nova versão encontrada",
    promptBody:
      "A versão {{version}} está disponível. Deseja atualizar agora?",
  ...
  statistics: {
    ...
    level: "Nível",
    xp: "XP",
    dailyTarget: "Meta de hoje",
    last30Days: "Últimos 30 dias",
    week: "Últimos 7 dias",
    topFocus: "Principais focos do período",
    noFocusData: "Sem dados de foco neste período.",
    unassignedFocus: "Foco sem tarefa",
    noMilestones: "Nenhum marco ainda.",
    milestones: {
      firstFocus: "Primeiro ciclo concluído",
      steadyThree: "3 dias seguidos",
      fullWeek: "7 dias seguidos",
      immersion: "Dia com 2h de foco",
      deepFocus: "Dia com 4 ciclos",
    },
