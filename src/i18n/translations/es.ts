export const es = {
  ...
  config: {
    ...
    shortFocusExtension: "Extensión corta",
    longFocusExtension: "Extensión larga",
  ...
  timer: {
    ...
    notifFocusExtensionAvailableTitle: "El enfoque está por terminar.",
    notifFocusExtensionAvailableBody:
      "Abre Pomodoroz para extender por {{shortDuration}} {{shortMinuteLabel}} o {{longDuration}} {{longMinuteLabel}}. Ignora este aviso para iniciar la pausa normalmente.",
    focusExtensionPrompt: "¿Continuar enfocado?",
  ...
  grid: {
    ...
    priorityModeFirst: "Prioridades: priorizadas primero",
    priorityModeOnly: "Prioridades: solo priorizadas",
  ...
  settings: {
    ...
    focusExtension: "Extender tiempo de enfoque",
    ...
    inAppAutoUpdate: "Actualización automática",
  ...
  statistics: {
    ...
    level: "Nivel",
    xp: "XP",
    dailyTarget: "Meta de hoy",
    last30Days: "Ultimos 30 dias",
    week: "Ultimos 7 dias",
    topFocus: "Focos principales del periodo",
    noFocusData: "No hay datos de enfoque en este período.",
    unassignedFocus: "Enfoque sin tarea",
    noMilestones: "Aun no hay hitos.",
    milestones: {
      firstFocus: "Primer ciclo completado",
      steadyThree: "Racha de 3 dias",
      fullWeek: "Racha de 7 dias",
      immersion: "Dia con 2h de enfoque",
      deepFocus: "Dia con 4 ciclos",
    },
