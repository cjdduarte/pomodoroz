...
| 3b — Flatten Structure            | In progress | 2026-04-17  | Kickoff completed (scripts, renderer `src` relocation, dependency consolidation, `shareables` operational decoupling, and workspace/package removal); remaining step is final monorepo collapse to single root package layout |
