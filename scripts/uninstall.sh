...
AUTOSTART_PATH="${HOME}/.config/autostart/pomodoroz.desktop"
AUTOSTART_PATH_TAURI="${HOME}/.config/autostart/com.cjdduarte.pomodoroz.desktop"
...
remove_path_if_exists "$AUTOSTART_PATH"
remove_path_if_exists "$AUTOSTART_PATH_TAURI"
