...
- **Native confirmation dialog titles are now standardized and localized** — timer and task-grid reset confirmations now use a generic per-language title (`Atenção`/`Warning`/etc.) instead of repeating the full question in the title bar.
