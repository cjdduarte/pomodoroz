...
- **Títulos de diálogos nativos de confirmação padronizados e localizados** — confirmações de reset no timer e no grid agora usam título genérico por idioma (`Atenção`/`Warning`/etc.) em vez de repetir a pergunta na barra de título.
